...
namespace _57Finance
{
    public partial class AlisFaturasi : Form
    {
        ...
        private void btnHrkEkle_Click(object sender, EventArgs e)
        {
            ...
            HzSec.Show();
        }   // Gride hizmet eklendiğinde çalışan kod....
        ...
        }  // Hareket Gridine Ekleme yapıldığında çalıştırılan kod bloğu (Hesaplama v.b)
        ...
        } // Hareket gridinde miktar vs gibi değişken olduğunda hesaplama döndüren kod.
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            if (GridHr.Rows.Count > 1)
            {
                ...
                baglanti.Close();
                zetters.WriteDocNumber("AlisFaturasi", "AFKey");
                this.Close();
            }
            else
